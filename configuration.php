...
class JConfig {
	...
	public $sitename = 'volley.ru';				// Name of Joomla site
	...
	public $host = 'eu-cdbr-azure-west-b.cloudapp.net';					// This is normally set to localhost
	public $user = 'b9b162b9b28faf';							// MySQL username
	public $password = 'e3a3e8e5';						// MySQL password
	public $db = 'volley';							// MySQL database name
